function pert1Page() {
    ...
    <p style="text-indent:1em;">Trigonometri berasal dari Bahasa yunani, trigonon artinya tiga sudut, dan metro artinya mengukur. Adapun rumus sinus, cosinus juga tangen diformulasikan oleh Surya siddhanta, ilmuwan india yang dipercaya hidup sekita abad 3SM. Selebihnya teori tentang Trigonometri disempurnakan oleh ilmuwan – ilmuwan lain di zaman berikutnya.</p>
    <p style="text-indent:1em;">Pada peradaban kehidupan budaya  Dayak, kajian mengenai Trigonometri sudah tercermin dari berbagai ikon kehidupan mereka. Misalnya para arsitektur sudah menerapkan kesetimbangan bangunan pada rumah adat  yang mereka ciptakan.</p>
    <div class="flex justify-content-center">
    <img src="../images/rumahadat.png" class="img-fluid" alt="Responsive image">
    </div>
    <p style="text-indent:1em;">Rumah adat tersebut berdiri kokoh sebagai hasil hubungan yang tepat antara besar sudut yang dikaitkan dengan panjang sisi –sisinya. Apakah para arsitektur tersebut mempelajari trigonometri juga? Pada sub bab ini akan dipahami konsep perbandingan trigonometri pada suatu segitiga siku – siku. Coba pahami deskripsi soal berikut.</p>
    ...
    <p style="text-indent:1em;">
    Pada gambar di atas kalian akan mengukur ketinggian pohon tersebut dengan menggunakan teorema phytagoras. Gambar di atas merupakan segitiga siku – siku dengan siku – siku di B. Segitiga di atas memiliki titik yaitu titik A,B dan C dengan masing – masing sisi yaitu sisi d sisi e dan sisi f.</p>
    <p style="text-indent:1em;">
    Berapakah tinggi pohon tersebut jika diketahui panjang AB = 3 m dan panjang AC = 5 m, dan tentukan nilai perbandingan pada sinus θ, cosinus θ, dan tangen θ?
    </p>
