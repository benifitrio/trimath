...
workbox.precaching.precacheAndRoute([
    ...
    { url: '/scripts/next5.js', revision: '1' },
    { url: '/scripts/next7.js', revision: '1' },
    { url: '/scripts/pert-1.js', revision: '1' },
    { url: '/scripts/next8.js', revision: '1' },
    { url: '/scripts/pert-2.js', revision: '1' },
    { url: '/scripts/pert-3.js', revision: '1' },
    { url: '/scripts/peta.js', revision: '1' },
    { url: '/scripts/petunjuk.js', revision: '1' },
    { url: '/scripts/uji.js', revision: '1' },
    { url: '/scripts/dapus.js', revision: '1' },
    { url: '/scripts/pembelajaran.js', revision: '1' },
    ...
    { url: '/images/masalah1.png', revision: '1' },
    { url: '/procedure.png', revision: '1' },
    { url: '/Picture2.jpg', revision: '1' },
    { url: '/images/segitiga.png', revision: '1' },
    { url: '/images/sinus.png', revision: '1' },
    { url: '/images/tangen.png', revision: '1' },
    { url: '/teacher.png', revision: '1' },
    { url: '/Picture1.jpg', revision: '1' },
    { url: '/images/masalah1.png', revision: '1' },
    { url: '/images/rumahadat.png', revision: '1' },
    { url: '/images/animasi.png', revision: '1' },
    { url: '/images/se.png', revision: '1' },
    { url: '/images/se1.png', revision: '1' },
    { url: '/images/cosinus.png', revision: '1' },
    { url: '/images/se2.png', revision: '1' },
    { url: '/images/peta1.png', revision: '1' },
    { url: '/images/trigonometri.png', revision: '1' },
    { url: '/images/satc.png', revision: '1' },
    { url: '/images/s1.png', revision: '1' },
    { url: '/images/s2.png', revision: '1' },
    { url: '/images/s3.png', revision: '1' },
    { url: '/images/buktikan2.png', revision: '1' },
